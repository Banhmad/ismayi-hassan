...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    searchMaintenanceServices: "Search for maintenance services...",
    noServicesFound: "No services found matching your search",
    chooseService: "Choose Service",
    chooseServiceDescription:
      "Browse service categories and choose what suits your needs",
    selectProvider: "Select Provider",
    selectProviderDescription:
      "Choose from verified service providers based on ratings and prices",
    bookService: "Book Service",
    bookServiceDescription:
      "Select a suitable time and book the service with one click",
    popularServices: "Popular Services",
    electrical: "Electrical",
    plumbing: "Plumbing",
    hvac: "HVAC",
    painting: "Painting",
    searchProviders: "Search for providers or services...",
    km: "km",
    ...
    describeIssue: "Describe the issue or required service in detail...",
    ...
    estimatedTotal: "Estimated Total",
    basedOnTwoHours: "Based on two hours of work",
  },
  ar: {
    home: "الرئيسية",
    services: "الخدمات",
    ...
    maintenanceServices: "خدمات الصيانة والأعمال المنزلية",
    searchMaintenanceServices: "ابحث عن خدمات الصيانة والأعمال المنزلية...",
    noServicesFound: "لم يتم العثور على خدمات مطابقة لبحثك",
    chooseService: "اختر الخدمة",
    chooseServiceDescription: "تصفح فئات الخدمات واختر ما يناسب احتياجاتك",
    selectProvider: "اختر مقدم الخدمة",
    selectProviderDescription:
      "اختر من بين مقدمي الخدمة المعتمدين بناءً على التقييمات والأسعار",
    bookService: "احجز الخدمة",
    bookServiceDescription: "حدد الوقت المناسب واحجز الخدمة بضغطة زر",
    popularServices: "الخدمات الأكثر طلباً",
    electrical: "الكهرباء",
    plumbing: "السباكة",
    hvac: "التكييف والتبريد",
    painting: "الدهان",
    searchProviders: "ابحث عن فنيين أو خدمات...",
    km: "كم",
    availability: "التوفر",
    today: "اليوم",
    tomorrow: "غداً",
    ...
    call: "اتصال",
    message: "مراسلة",
    noProvidersFound: "لم يتم العثور على فنيين مطابقين لبحثك",
    ...
    enterAddress: "أدخل العنوان بالتفصيل",
    serviceDescription: "وصف الخدمة المطلوبة",
    describeIssue: "صف المشكلة أو الخدمة المطلوبة بالتفصيل...",
    uploadImages: "إرفاق صور (اختياري)",
    addPhoto: "إضافة صورة",
    paymentMethod: "طريقة الدفع",
    cashOnService: "الدفع عند تقديم الخدمة",
    onlinePayment: "الدفع الإلكتروني",
    confirmBooking: "تأكيد الحجز",
    serviceProvider: "مقدم الخدمة",
    serviceType: "نوع الخدمة",
    estimatedTotal: "التكلفة التقديرية",
    basedOnTwoHours: "بناءً على ساعتين من العمل",
  },
  fr: {
    home: "Accueil",
    services: "Services",
